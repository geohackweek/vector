...
* *(In French)* 2016-2: [Python à finalité géospatiale: pourquoi débuter avec le module ogr alors qu'il existe des alternatives plus simples et plus didactiques?](http://www.portailsig.org/content/nouv)
* *(In French)* 2014-10: [Les notebooks IPython comme outil de travail dans le domaine géospatial ou le plaisir de partager, de collaborer et de communiquer](http://www.portailsig.org/content/les-notebooks-ipython-comme-outil-de-travail-dans-le-domaine-geospatial-ou-le-plaisir-de-par)
* 2015: [kjordahl/SciPy-Tutorial-2015: Geospatial data tutorial (geopandas)](https://github.com/kjordahl/SciPy-Tutorial-2015)
* Filipe: Folium and other mapping tools
